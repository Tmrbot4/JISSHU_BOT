...
API_ID = int(environ.get('23171051'))
API_HASH = environ.get('10331d5d712364f57ffdd23417f4513c')
BOT_TOKEN = environ.get('6711098354:AAGS3M66gBjUVn_57kso8CGlekRuAf2goDw')
...
auth_channel = environ.get('-1002181454692')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002248695395')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002116256784')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tmr624062:Jishu123@cluster0.pvwfmfd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+1pti-MmEA1sxMDg1')
